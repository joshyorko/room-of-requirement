...
class MaintenanceReport:
    ...
    homebrew: List[HomebrewUpdate] = field(default_factory=list)
    ...
    def add_homebrew_update(self, update: HomebrewUpdate) -> None:
        self.homebrew.append(update)
    ...
    def to_dict(self) -> Dict[str, List[Dict[str, object]]]:
        return {
            ...
            "homebrew": [item.to_dict() for item in self.homebrew],
        }
